            ...
            (_auth.currentUser != null)
                ? ((_auth.currentUser.uid == recipe.userID)
                  ? IconButton(
                      ...
                      MaterialPageRoute(builder: (context) => EditPage(recipe: recipe,)));
                },)
                  : Container())
              : Container(),
            Padding(
                ...
                child: _auth.currentUser != null ?
                  IconButton(
                    ...
                    icon: (_auth.currentUser != null) ? (recipe.favorite.contains(_auth.currentUser.uid) ? Icon(Icons.star_outlined) : Icon(Icons.star_border)) : null,
                  color: (_auth.currentUser != null) ? (recipe.favorite.contains(_auth.currentUser.uid) ? Colors.orangeAccent : Colors.white) : null,
                iconSize: 35,)
            : Container())
          ],
        ),
